...
hep_run <- s3readRDS("data/final/hep_run.Rds", bucket)
data_wt_avg <- s3readRDS("data/final/data_wt_avg.Rds", bucket)
patients <- s3readRDS("data/final/patients.Rds", bucket)
temp_ptt_full <- s3readRDS("data/final/temp_ptt_full.Rds", bucket)
temp_ptt <- s3readRDS("data/final/temp_ptt.Rds", bucket)
hep_protocol <- s3readRDS("data/final/hep_protocol.Rds", bucket)
hep_drip <- s3readRDS("data/final/hep_drip.Rds", bucket)

ck_heparin <- s3readRDS("data/final/ck_heparin.Rds", bucket)
ck_ptt <- s3readRDS("data/final/ck_ptt.Rds", bucket)
ck_temp <- s3readRDS("data/final/ck_temp.Rds", bucket)
