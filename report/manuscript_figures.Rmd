...
ptt_run %>%
    ...
    # geom_point(aes(color = order), shape = 1) +
    ...
    # scale_linetype_discrete("TTM Protocol", labels = c("ACS", "VTE", "Stroke Prevention")) +
    scale_linetype_manual("TTM Protocol", values = c(1, 2, 3), labels = c("ACS", "VTE", "Stroke")) +
